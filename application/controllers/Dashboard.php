  ...
  //       };
    ...
    public function index() {
      ...
      $thnm=$tahunmin;
		...
		// Pengaduan Perempuan
		$data['tahunpengaduanper']=$this->m_pengaduanper->tampil_tahun();
		$data['tahunpengaduanank']=$this->m_pengaduanank->tampil_tahun();
		$data['tahunpengaduanker']=$this->m_pengaduanker->tampil_tahun();
		
		// Grafik Banyak kendaraan
		$tahun11=$this->m_banyakkendaraan->tampil_tahunmin();
		  foreach ($tahun11->result_array() as $a){
			  $tahun1=intval($a['periode']);
		  }
		$tahun22=$this->m_banyakkendaraan->tampil_tahunmax();
			foreach ($tahun22->result_array() as $b){
			  $tahun2=intval($b['periode']);
		  }
		$data['banyakkendaraan']=$this->m_banyakkendaraan->grafik_Perbandingan_perumahanx($tahun1, $tahun2);
