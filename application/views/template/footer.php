...
<?php } 
	...
	if($pages=="tampil_crosstab_jumlah_koleksi_buku"){
?>
<script type="text/javascript">
   $(document).ready(function() {
     var end;
...
<script type="text/javascript">
  $(document).ready(function() {
	...
	$("#tahunpengaduanper").change(function () {
	    ...
	    var tp2 = $('#tampilpengaduanank').DataTable( {
		"bPaginate": true,
		"bLengthChange": false,
		"bFilter": true,
		"bInfo": true,
	...
	$("#tahunpengaduanank").change(function () {
		
        end1 = this.value;
		console.log(end1);
		tp2.ajax.url( 'Pengaduanank/get?tahun='+end1 ).load();
    });
	
	    var tp3 = $('#tampilpengaduanker').DataTable( {
		"bPaginate": true,
		"bLengthChange": false,
		"bFilter": true,
		"bInfo": true,
	...
	$("#tahunpengaduanker").change(function () {
		
        end2 = this.value;
		console.log(end2);
		tp3.ajax.url( 'Pengaduanker/get?tahun='+end2 ).load();
    });
