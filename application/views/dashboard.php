    ...
    <?php } ?>
		...
		<div class="row">
            <div class="col-md-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">Laporan Pemberdayaan Perempuan dan Perlindungan Anak</h3>
                        <div class="box-tools pull-right">
                            <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
                            </button>
                            <button type="button" class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
					...
					<div class="nav-tabs-custom">
						<ul class="nav nav-tabs">
						  <li class="active"><a href="#perempuan" data-toggle="tab">Pengaduan Perempuan</a></li>
						  <li><a href="#anak" data-toggle="tab">Pengaduan Anak</a></li>
						  <li><a href="#kekerasan" data-toggle="tab">Pengaduan Kekerasan</a></li>
						</ul>
						<div class="tab-content">
							<div class="tab-pane active" id="perempuan">
								<div class="row">
									<div class="col-md-12">
										<div class="box-tools pull-left">
											...
											<tr>
												...
												<td>
													<select name="tahunpengaduanper" id="tahunpengaduanper" class="form-control" required>
														<option value="0000"> Pilih Tahun </option>
														<?php 
														foreach ($tahunpengaduanper->result_array() as $a){
														$periode=$a['periode'];
										...
										<table class="table table-bordered table-striped compact cell-border  display" style="font-size:15px; width:100%; text-align:center"  id="tampilpengaduanper">
											<thead>
												<tr>
													...
													<th style="text-align:center;width:5%;text-align:center;vertical-align:middle;" rowspan="2">Aksi</th>
												</tr>
												<tr>
									...
									<div class="col-md-12">
										<div class="box-tools pull-middle">
											...
											<tr>
												...
												<td>
													<select name="tahunpengaduanank" id="tahunpengaduanank" class="form-control" required>
														<option value="0000"> Pilih Tahun </option>
														<?php 
														foreach ($tahunpengaduanank->result_array() as $a){
														$periode=$a['periode'];
														?><option value="<?php echo $periode; ?>"> <?php echo $periode; ?> </option>
														<?php } ?>
													</select>
							...
							<div class="tab-pane" id="kekerasan">
								<div class="row">
									<div class="col-md-12">
										<div class="box-tools pull-left">
											<table>
											<tr>
												...
												<td>
													<select name="tahunpengaduanker" id="tahunpengaduanker" class="form-control" required>
														<option value="0000"> Pilih Tahun </option>
														<?php 
														foreach ($tahunpengaduanker->result_array() as $a){
														$periode=$a['periode'];
														?><option value="<?php echo $periode; ?>"> <?php echo $periode; ?> </option>
														<?php } ?>
													</select>
		...
		<div class="row">
			<div class="col-md-6">
                <div class="box box-success">
                    <div class="box-header with-border">
                        <h3 class="box-title">Dinas Perhubungan</h3>
                    ...
                    <div class="box-body">
                       <?php
						...
						$jumlah=array();
						$periode=array();
							foreach ($banyakkendaraan->result_array() as $a) {
								$periode[]=intval($a['periode']);
								$mpu[]=intval($a['mpu']);
								$bus[]=intval($a['bus']);
                        ...
                        ?>
						<div class="box" id="grafikbanyakkendaraan" style="min-width: 10%; max-width: 90%; height: 100%; margin: 0 auto;">
						<script src="<?php echo base_url(); ?>assets/highcharts/highcharts.js"></script>
						<script src="<?php echo base_url(); ?>assets/highcharts/exporting.js"></script>
						<script src="<?php echo base_url(); ?>assets/highcharts/export-data.js"></script>
						<script type="text/javascript">
						Highcharts.chart('grafikbanyakkendaraan', {
							chart: {
								type: 'column'
							},
							title: {
							...
							series: [
								{
									...
									data: [
										...
										for($x = 0; $x < $arrlength; $x++) {?>
										{
											name: <?php echo json_encode(intval($periode[$x])); ?>,
											y: <?php echo json_encode(intval($jumlah[$x])); ?>,
											drilldown: <?php echo json_encode(intval($periode[$x])); ?>
										}
										<?php
										if($x < $arrlength-1){
										echo ",";
							...
							drilldown: {
								series: [
									<?php $arrlength = count($periode);
										...
										{
										name: <?php echo json_encode(intval($periode[$x])); ?>,
										id: <?php echo json_encode(intval($periode[$x])); ?>,
											data: [
												[
													"Jumlah mpu",
